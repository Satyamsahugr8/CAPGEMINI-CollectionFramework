...
public class B_StandardDeviationOfArrayUsingMultipleThreading {
	...
	public static void main(String[] args) throws Exception {
		...
		// Here i have created different threads (tA,tB,tC,tD,tE) for calculation of mean
		
		// Here below I have created 5 threads for calculating mean of the given array
		// So we have 100 integers so each threads is working simultaneously on there threads
...
//		System.out.println("mean from B = " + strd.mean);  // mean from B = 87.0
		...
		// here i asking the Main thread to stop till t1 joins the main thread and for other threads too.
		t1.join();
		t2.join();
		t3.join();
		t4.join();
		...
		// here i am calling the updated Sd or standard Deviation from the A_StandardDeviationofArray2 class
		System.out.println("Standard Deviation using MT = " + strd.Sd); //Standard Deviation using MT = 52.73006732406095
