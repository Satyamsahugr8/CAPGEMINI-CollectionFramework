package com.java.assignment.second;

import java.util.Scanner;

import com.java.learning.oops.multipleInheritance.Userinput;

public class Main {

	/*
	 * how to start this application first user needs to enter where he needs to use
	 * this remote for television or air condition or washing machine At each input
	 * user will get information about next step and i have added almost all the
